...
const StarIcon: React.FC = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 26 26" fill="currentColor">
    <g>
      <defs>
        <mask id="SVGNz87ymEu">
          <path fill="#fff" d="M0 0h26v26H0z"/>
          <path stroke="#000" strokeLinejoin="round" strokeWidth="2" d="M9.999 10.57L12 4l2.002 6.571L20 12.764l-5.952 2.364L12 22l-2.048-6.872L4 12.764z"/>
